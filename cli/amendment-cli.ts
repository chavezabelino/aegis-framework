...
class AmendmentCLI {
  ...
  async createProposal(): Promise<void> {
    ...
    const sampleProposal = {
      ...
      proposedText:
        'Add Article X: AI Learning Integration - All framework components shall integrate with the AI learning system for continuous improvement and pattern recognition.',
      rationale:
        'The successful implementation of Pattern Recognition and Predictive Enforcement demonstrates the value of AI learning. This amendment formalizes AI integration as a constitutional requirement.',
      implementationPlan: [
