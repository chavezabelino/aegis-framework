...
class TemplateQualityValidator {
  ...
  validateMarkdownStructure(content, filePath) {
  ...
  validateConstitutionalAnnotations(content, filePath) {
  ...
  validateFormatConsistency(content, filePath) {
...
module.exports = { TemplateQualityValidator };
