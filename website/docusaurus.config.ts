...
const config: Config = {
  ...
  url: 'https://chavezabelino.github.io', // Your GitHub username
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/aegis-framework/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/chavezabelino/aegis-framework',
          label: 'GitHub',
          position: 'right',
        },
      ],
