...
**⚠️ Design Evolution Note**: Initial design incorrectly suggested dependency bundling. Following user feedback (EVS-2025-08-07-008), corrected to industry-standard NPM dependency declaration approach.
