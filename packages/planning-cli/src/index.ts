...
import type { PlanClass, PlanningPlan, PlanningError } from '../../../types/planning';
      ...
      .action(async (prompt: string, options: { output: string; verbose: boolean }) => {
        try {
          ...
          if (options.verbose) {
            ...
            console.log('\nReasoning:');
            result.reasoning.forEach((reason: string) => console.log(`  • ${reason}`));
          }
      ...
      .action(
        async (
          ...
          try {
            ...
            analysis1.reasoning.forEach((reason: string) => console.log(`  • ${reason}`));

            console.log('\nPlan B Analysis:');
            analysis2.reasoning.forEach((reason: string) => console.log(`  • ${reason}`));
            ...
            comparison.reasoning.forEach((reason: string) => console.log(`  • ${reason}`));
          } catch (error) {
